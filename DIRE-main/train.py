...
if __name__ == "__main__":
    ...
    cfg.dataset_root = os.path.join(cfg.dataset_root, "train")#D:\github_local_project\DIRE-main\data\train
    ...
    train_writer = SummaryWriter(os.path.join(cfg.exp_dir, "train"))#将一些训练信息存储在路径对应的文件下
    ...
    for epoch in range(cfg.nepoch):#cfg.nepoch=400
