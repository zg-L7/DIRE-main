...
def get_val_cfg(cfg: CONFIGCLASS, split="val", copy=True):
    ...
    #D:\github_local_project\DIRE-main\data\val或者D:\github_local_project\DIRE-main\data\test
    val_cfg.datasets = cfg.datasets_test#"adm_res_abs_ddim20s"
...
def validate(model: nn.Module, cfg: CONFIGCLASS):
    ...
    with torch.no_grad():
        ...
        for data in data_loader:
            ...
            y_pred.extend(predict.flatten().tolist())#.flatten()用于将数组和张量扁平化，即将多维转化为一维
