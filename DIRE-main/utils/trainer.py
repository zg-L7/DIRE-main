...
class BaseModel(nn.Module):
    ...
    def save_networks(self, epoch: int):#保存模型参数信息
    ...
    def load_networks(self, epoch: int):#加载模型网络参数
        ...
        if hasattr(state_dict, "_metadata"):
            #检查 state_dict 对象是否具有 _metadata 属性，并在具有该属性时删除 _metadata 属性
        ...
        if self.isTrain and not self.cfg.new_optim:
            ...
            for state in self.optimizer.state.values():#将优化器中的状态信息移到指定设备中
